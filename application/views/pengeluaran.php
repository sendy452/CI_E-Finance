                    ...
                    <div class="table-responsive" >
                        <table class="table table-bordered" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?=$no++;?></td>
                                    <td><?=date("d/m/Y", strtotime($transaksi->tgl_pengeluaran));?></td>
                                    <td><?=$transaksi->jumlah?></td>
                                    <td><?=$transaksi->keterangan?></td>
                                    <td>
                                        <!-- Button untuk modal -->
                                        <a href="#" type="button" class=" fa fa-edit btn btn-primary btn-md" data-toggle="modal" data-target="#myModal<?=$transaksi->id_pengeluaran?>"></a>
                                    </td>
                                </tr>
                                <!-- Modal Edit-->
                                <div class="modal fade" id="myModal<?=$transaksi->id_pengeluaran?>" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form role="form" action="<?=base_url('h/update_pengeluaran');?>" method="post">
                                                    <input type="hidden" name="id_pengeluaran" value="<?=$transaksi->id_pengeluaran?>">
                                                    <div class="form-group">
                                                        <label>Tanggal</label>
                                                        <input type="date" name="tgl_pengeluaran" class="form-control" value="<?=$transaksi->tgl_pengeluaran?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Jumlah</label>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="<?=base_url('h/hapus_pengeluaran/'.$transaksi->id_pengeluaran);?>" Onclick="confirm('Anda Yakin Ingin Menghapus?')" class="btn btn-danger">Hapus</a>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
